...
object CalculatorHelp {
    ...
    <table class="grid">
        ...
        <tr><td><strong>Inflation Rate (%)</strong></td><td>Baseline annual inflation rate (CPI-U, e.g. 2.25%) applied to spending and Social Security COLAs. Federal tax brackets and standard deductions are adjusted by Chained CPI (C-CPI-U), which indexes at ~0.2% lower than CPI-U.</td></tr>
    ...
    <ul>
        ...
        <li><strong>Chained CPI (C-CPI-U) Indexing:</strong> In accordance with IRS statutory rules under the TCJA, federal ordinary income brackets, capital gains brackets, and standard deductions are indexed annually using Chained CPI-U, which tracks approximately 0.2% below general CPI-U inflation.</li>
    </ul>
